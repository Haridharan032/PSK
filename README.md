...
Google Colab
# Theory
## PSK (Phase Shift Keying) – Theory

Phase Shift Keying (PSK) is a digital modulation technique in which the **phase of the carrier signal is changed** according to the input binary data.

In BPSK:
- 0 → 0°
- 1 → 180°

It is simple and has good noise resistance, but transmits only **1 bit per symbol**.


## QPSK (Quadrature Phase Shift Keying) – Theory

QPSK is an advanced form of PSK where **four different phases** are used to represent data.

Each symbol represents **2 bits**, so it provides a **higher data rate** than BPSK.

It uses two components:
- In-phase (I)
- Quadrature (Q)

QPSK is more efficient but slightly more complex.
# Program
## PSK
```
import numpy as np
...
# Output Waveform
## PSK
<img width="573" height="520" alt="image" src="https://github.com/user-attachments/assets/0f066882-ff13-4192-87ed-72e17a802888" />

## QPSK
<img width="575" height="459" alt="image" src="https://github.com/user-attachments/assets/5923f8d2-60ab-4fb7-a674-560928ec4859" />
